...
def evaluate(
    ...
    return {
        ...
        "limitations": [
            ...
            "Hyperliquid funding notional uses perpetual close as an oracle-price proxy.",
            "Capital, margin and liquidation are venue-specific and separately funded.",
            "The return-target rejection applies to the preregistered maximum 2x pair notional.",
